	...
	*/
	...
	function system_info( $version ) {
		...
		?>
			...
			<tr>
				<td>
					<strong>J-One-Plus Version:</strong>
				</td>
				<td>
					<?php echo $version; ?>
				</td>
			...
			<tr>
				...
				<td>
					...
					<tr>
						<td width="250">
							J-One-Plus Register Globals Emulation:
						</td>
			...
			<tr>
				...
				foreach ($cf as $k=>$v) {
					if (false !== stripos($v, 'mosConfig_host')) {
						$cf[$k] = '$mosConfig_host = \'xxxxxx\'';
					} else if (false !== stripos($v, 'mosConfig_user')) {
						$cf[$k] = '$mosConfig_user = \'xxxxxx\'';
					} else if (false !== stripos($v, 'mosConfig_password')) {
						$cf[$k] = '$mosConfig_password = \'xxxxxx\'';
					} else if (false !== stripos($v, 'mosConfig_db ')) {
		...
		?>
			...
			<tr>
				<td>
					<strong>For all J-One-Plus functions and features to work ALL of the following directories should be writeable:</strong>
					<?php
