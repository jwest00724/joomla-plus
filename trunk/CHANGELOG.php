...
J-One-Plus version 1.0 was created by including some elements of the
Aliro CMS framework and by dealing with code changes in the Joomla 1.0
code so as to run with PHP 5.3.x

More detailed changes logs will be provided in future versions
of J-One-Plus.
