...
<head>
<title><?php echo $mosConfig_sitename; ?> - Administration [J-One-Plus]</title>
...
<meta name="Generator" content="J-One-Plus Content Management System" />
...
<div id="wrapper">
	<div id="header">
			<div id="joomla"><img src="templates/joomla_admin/images/header_text.png" alt="J-One-Plus Logo" /></div>
	</div>
</div>
	...
	<tr>
		<td align="center">
			...
			<div align="center" class="smallgrey">
				<?php echo $version; ?>
				<br />
				<a href="http://www.joomlaguru.net/latestj1/" target="_blank">Check for latest Version</a>
			</div>
			<?php
			if ( $mosConfig_debug ) {
