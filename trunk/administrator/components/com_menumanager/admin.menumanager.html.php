	...
	*/
	function edit ( &$row, $option ) {
		...
		<tr height="45px;">
			...
			<?php
			$tip = 'This is the identification name used by J-One-Plus to identify this menu within the code - it must be unique. Recommend that you do not have any spaces in your Menu Name';
			echo mosToolTip( $tip );
			?>
			</td>
		</tr>
