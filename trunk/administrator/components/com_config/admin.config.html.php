...
class HTML_config {
	...
	function showconfig( &$row, &$lists, $option) {
		...
		$tabs->startTab("Site","site-page");
			...
			<tr>
				...
				<td><textarea class="text_area" cols="60" rows="2" style="width:500px; height:40px" name="config_error_message"><?php echo $row->config_error_message; ?></textarea><?php
					$tip = 'A message that displays if J-One-Plus could not connect to the database';
					echo mosToolTip( $tip );
				?></td>
			</tr>
			<tr>
		...
		$tabs->startTab("Metadata","metadata-page");
			...
			<tr>
				<td valign="top">Front Page Title:</td>
				<td><textarea class="text_area" cols="50" rows="1" style="width:500px; height:50px" name="config_MetaHomeTitle"><?php echo $row->config_MetaHomeTitle; ?></textarea></td>
			</tr>
			<tr>
