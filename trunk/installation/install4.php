...
if ($siteUrl) {
	...
	$config .= "\$mosConfig_MetaDesc = 'J-One-Plus - the dynamic portal engine and content management system';\n";
	$config .= "\$mosConfig_MetaKeys = 'J-One-Plus';\n";
	...
	if ($filePerms != '' || $dirPerms != '') {
		...
		if ($chmodOk) {
			...
			$chmod_report = 'File and directory permissions could not be changed.<br />'.
							'Please CHMOD J-One-Plus files and directories manually.';
		}
	} // if chmod wanted
	$installdir = new aliroDirectory(dirname(__FILE__));
	$installdir->deleteAll();
	$delmessage = is_dir(dirname(__FILE__)) ? 'PLEASE REMEMBER TO COMPLETELY<br/>REMOVE THE INSTALLATION DIRECTORY' :
		'THE INSTALLTION SYSTEM HAS<br/>REMOVED THE INSTALLATION DIRECTORY';
} else {
?>
...
?>/>
			...
			<div class="clr"></div>
			<h1>Congratulations! J-One-Plus is installed</h1>
			<div class="install-text">
				<p>Click the "View Site" button to start J-One-Plus site or "Administration"
					to take you to administrator login.</p>
			</div>
			<div class="install-form">
				<div class="form-block">
					<table width="100%">
						<tr><td class="error" align="center"><?php echo $delmessage; ?></td></tr>
