...
function view() {
	...
	<div id="wrapper">
		<div id="header">
			<div id="joomla">
				<img src="header_install.png" alt="J-One-Plus Installation" />
			</div>
		</div>
	</div>
		...
		<div class="install">
			...
			<div id="right">
				...
				<div class="install-text">
					...
					<p>
						Failure to do so could lead to your J-One-Plus installation not functioning correctly.
					</p>
					<div class="ctr"></div>
				</div>
				...
				<div class="install-form">
					<div class="form-block">
						...
						<tr>
							...
							<td align="left">
								<?php echo (!function_exists('version_compare') OR version_compare(PHP_VERSION, '5.2.3') < 0) ? '<b><font color="red">No</font></b>' : '<b><font color="green">Yes</font></b>';?>
							</td>
						</tr>
						<tr>
							<td>
				...
				<div class="install-text">
					<p>
						...
						compatibility with J-One-Plus.
					</p>
					<p>
						However, J-One-Plus will still operate if your settings do not quite match the recommended
					</p>
					<div class="ctr"></div>
				</div>
				...
				<div class="install-text">
					<p>
						In order for J-One-Plus to function correctly it needs to be able to access or write to certain files or directories.
					</p>
					<p>
						If you see "Unwriteable" you need to change the permissions on the file or directory to allow J-One-Plus to write to it.
					</p>
					<div class="clr">&nbsp;&nbsp;</div>
					<div class="ctr"></div>
				</div>
