...
if (!$DBcreated){
	...
	$resource = mysql_connect($DBhostname, $DBuserName, $DBpassword);
...
<?php } ?>
  			...
  			<h1>Enter the name of your J-One-Plus site:</h1>
...
<?php } else { ?>
			...
			<br/>
			<br/>
  			Type in the name for your J-One-Plus site. This
...
?>
  				...
  				<tr>
  					<td width="100">&nbsp;</td>
  					<td align="center" class="small">e.g. The Home of J-One-Plus</td>
  				</tr>
  				</table>
<?php
  			} // if
