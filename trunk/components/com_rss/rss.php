...
function feedFrontpage( $showFeed ) {
	...
	$info[ 'title' ] 			= $params->def( 'title', 'J-One-Plus powered Site' );
	$info[ 'description' ] 		= $params->def( 'description', 'J-One-Plus site syndication' );
	...
	$info[ 'image_alt' ] 		= $params->def( 'image_alt', 'Powered by J-One-Plus' );
