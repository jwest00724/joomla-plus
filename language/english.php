...
DEFINE('_MAINMENU_DEL','* You cannot `delete` this Menu as it is required for the proper operation of J-One-Plus *');
...
DEFINE('_PDF_POWERED','Powered by J-One-Plus');
?>